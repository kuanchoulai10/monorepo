...
- [x] System Design Mock Interview with Kevin and Shirley
    - [x] Design a Rate Limiter w/ Shirley
    - [x] Design a Ride-Sharing Service like Uber w/ Shirley
    - [ ] Design a Ticket Master w/ Kevin
    - [ ] Design a Distributed Message Queue w/ Kevin
