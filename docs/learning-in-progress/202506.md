...
- [ ] Published a blog post: [The Lakehouse Series: DuckLake — The Next Big Thing?](https://example.com)
- [ ] Published a blog post: [The Lakehouse Series: Hudi vs Iceberg vs Delta — Format Wars Begin](https://example.com)
- [ ] Published a blog post: [The Lakehouse Series: OLTP vs. OLAP (A Parquet Primer)](https://example.com)
