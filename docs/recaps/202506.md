...
- [x] Published a blog post: [The Lakehouse Series: OLTP vs. OLAP (A Parquet Primer)](../blog/posts/2025/01-06/oltp-vs-olap-a-parquet-primer/oltp-vs-olap-a-parquet-primer.md)
- [x] Published a blog post: [How to Use MkDocs to Integrate GitHub Actions and Git Submodule for Cross-repo Documentation](../blog/posts/2025/01-06/cross-repo-docs-mkdocs-workflow/cross-repo-docs-mkdocs-workflow.md)
